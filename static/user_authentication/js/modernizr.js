!function (e, t, n) {
    ...
    function o(e) {
        var t = C.className, n = S._config.classPrefix || "";
    ...
    function f(e, n, r, i) {
        var o, a, s, l, f = "modernizr", d = u("div"), p = c();
        if (parseInt(r, 10)) for (; r--;) s = u("div"), s.id = i ? i[r] : f + (r + 1), d.appendChild(s);
    ...
    function h(e, t, i, o) {
        ...
        for (d = e.length, f = 0; d > f; f++) if (h = e[f], g = _.style[h], l(h, "-") && (h = m(h)), _.style[h] !== n) {
    ...
    function g(e, t, n) {
        var i;
        for (var o in e) if (e[o] in t) return n === !1 ? e[o] : (i = t[e[o]], r(i, "function") ? s(i, n || t) : i);
        return !1
    }

    function v(e, t, n, i, o) {
        var a = e.charAt(0).toUpperCase() + e.slice(1), s = (e + " " + P.join(a + " ") + a).split(" ");
    ...
    var b, w = [], C = t.documentElement, T = "svg" === C.nodeName.toLowerCase();
    !function () {
    ...
    T || !function (e, t) {
        ...
        e.html5 = C, u(t);
        var T = /^$|\b(?:all|print)\b/, N = "html5shiv", _ = !g && function () {
    ...
    e.matchMedia = e.matchMedia || function (e, t) {
        var n, r = e.documentElement, i = r.firstElementChild || r.firstChild, o = e.createElement("body"),
    ...
    if (n.ajax = o, n.queue = r, n.regex = {
        ...
        var a, s, l, u = e.document, c = u.documentElement, f = [], d = [], p = [], m = {}, h = 30,
            g = u.getElementsByTagName("head")[0] || c, v = u.getElementsByTagName("base")[0],
            y = g.getElementsByTagName("link"), x = function () {
                var e, t = u.createElement("div"), n = u.body, r = c.style.fontSize, i = n && n.style.fontSize, o = !1;
                ...
                var n = "clientWidth", r = c[n], i = "CSS1Compat" === u.compatMode && r || u.body[n] || r, o = {},
                    m = y[y.length - 1], v = (new Date).getTime();
                if (t && a && h > v - a) return e.clearTimeout(s), void(s = e.setTimeout(E, h));
                a = v;
                for (var S in f) if (f.hasOwnProperty(S)) {
                    var b = f[S], w = b.minw, C = b.maxw, T = null === w, N = null === C, _ = "em";
                ...
                for (var t = 0; t < y.length; t++) {
                    var n = y[t], i = n.href, o = n.media, a = n.rel && "stylesheet" === n.rel.toLowerCase();
