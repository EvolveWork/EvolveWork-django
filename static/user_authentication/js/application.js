...
if ("document" in self && ("classList" in document.createElement("_") ? !function () {
    ...
    "use strict";
    if ("Element" in t) {
        var e = "classList", n = "prototype", o = t.Element[n], i = Object, r = String[n].trim || function () {
        ...
        if (a[n] = Error[n], u.item = function (t) {
            ...
            var t, e, n = arguments, o = 0, i = n.length, r = !1;
            do for (t = n[o] + "", e = c(this, t); -1 !== e;) this.splice(e, 1), r = !0, e = c(this, t); while (++o < i);
            r && this._updateClassName()
        }, u.toggle = function (t, e) {
            t += "";
            var n = this.contains(t), o = n ? e !== !0 && "remove" : e !== !1 && "add";
    ...
    var e = navigator.userAgent.indexOf("Windows Phone") >= 0, n = navigator.userAgent.indexOf("Android") > 0 && !e,
        ...
        r = o && /OS [6-7]_\d/.test(navigator.userAgent), s = navigator.userAgent.indexOf("BB10") > 0;
    ...
    t.version = "0.6.0", t.utils = {}, t.utils.warn = function (t) {
        ...
        var o = {}, i = new t.SortedSet, r = e[this._ref], n = void 0 === n ? !0 : n;
        ...
        for (var s = 0; s < i.length; s++) {
            var a = i.elements[s], c = this._fields.reduce(function (t, e) {
        ...
        var n = this.tokenStore.count(t), o = 1;
        return n > 0 && (o = 1 + Math.log(this.documentStore.length / n)), this._idfCache[e] = o
    }, t.Index.prototype.search = function (e) {
        var n = this.pipeline.run(t.tokenizer(e)), o = new t.Vector, i = [], r = this._fields.reduce(function (t, e) {
            return t + e.boost
        ...
        n.forEach(function (e, n, s) {
            var a = 1 / s.length * this._fields.length * r, c = this,
                l = this.tokenStore.expand(e).reduce(function (n, i) {
                    var r = c.corpusTokens.indexOf(i), s = c.idf(i), l = 1, u = new t.SortedSet;
                    if (i !== e) {
        ...
        for (var n = this.documentStore.get(e), o = n.length, i = new t.Vector, r = 0; o > r; r++) {
            var s = n.elements[r], a = this.tokenStore.get(s)[e].tf, c = this.idf(s);
        ...
        var t = {
                ...
                biliti: "ble",
                logi: "log"
            }, e = {icate: "ic", ative: "", alize: "al", iciti: "ic", ical: "ic", ful: "", ness: ""}, n = "[^aeiou]",
            o = "[aeiouy]", i = n + "[^aeiouy]*", r = o + "[aeiou]*", s = "^(" + i + ")?" + r + i,
            a = "^(" + i + ")?" + r + i + "(" + r + ")?$", c = "^(" + i + ")?" + r + i + r + i, l = "^(" + i + ")?" + o,
            u = new RegExp(s), d = new RegExp(c), h = new RegExp(a), f = new RegExp(l), p = /^(.+?)(ss|i)es$/,
            m = /^(.+?)([^s])s$/, v = /^(.+?)eed$/, g = /^(.+?)(ed|ing)$/, y = /.$/, w = /(at|bl|iz)$/,
            S = new RegExp("([^aeiouylsz])\\1$"), k = new RegExp("^" + i + o + "[^aeiouwxy]$"), E = /^(.+?[^aeiou])y$/,
            ...
            C = /^(.+?)(s|t)(ion)$/, L = /^(.+?)e$/, _ = /ll$/, A = new RegExp("^" + i + o + "[^aeiouwxy]$"),
            O = function (n) {
                var o, i, r, s, a, c, l;
        ...
        var n = n || this.root, o = t.charAt(0), i = t.slice(1);
        return o in n || (n[o] = {docs: {}}), 0 === i.length ? (n[o].docs[e.ref] = e, void(this.length += 1)) : this.add(i, e, n[o])
        ...
        var n = this.getNode(t), o = n.docs || {}, e = e || [];
    ...
    for (var e = t.length - 1; e >= 0; e--) {
        var n = e > 0 ? this.cloneNode(!0) : this, o = t[e], i = o.parentNode, r = o.nextSibling;
    ...
    var t = document.getElementById("toggle-search"),
        ...
        n = document.querySelectorAll(".anchor"), o = document.querySelector(".search .field"),
        i = document.querySelector(".query"), r = document.querySelector(".results .meta");
    ...
    var s = window.pageYOffset, a = function () {
        var t = window.pageYOffset + window.innerHeight, n = Math.max(0, window.innerHeight - e.offsetHeight);
    ...
    var l = function () {
        pegasus(base_url + "/mkdocs/search_index.json").then(function (e, n) {
            var o = lunr(function () {
                this.field("title", {boost: 10}), this.field("text"), this.ref("location")
            }), s = {};
            e.docs.map(function (t) {
                ...
                a.map(function (n) {
                    var o = s[n.ref], i = document.createElement("article");
    ...
    t.addEventListener("click", function (t) {
        var e = document.body.classList, n = !matchMedia("only screen and (min-width: 960px)").matches;
    ...
    document.addEventListener("click", function (t) {
        for (node = t.target; "A" !== node.nodeName && "HTML" !== node.nodeName;) node = node.parentNode;
