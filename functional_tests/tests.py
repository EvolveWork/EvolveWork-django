...
class UserTestsWhileLoggedOutSelenium(unittest.TestCase):
    ...
    def test_site_load(self):
        ...
        navigation_while_logged_out = self.browser.find_elements_by_class_name(
            "navigation"
        )
...
class UserTestsWhileLoggedIn(TestCase):
    ...
    def test_navigation_options_changed(self):
        ...
        self.assertIn(
            '<li><a title="Charge" class="navigation" href="/charge/">Subscribe</a></li>',
            processed_response,
        )
        self.assertIn(
            '<li><a title="Account" class="navigation" href="/charge/account/">Account</a></li>',
            processed_response,
        )
        self.assertIn(
            '<li><a title="Logout" class="navigation" href="/logout/">Logout</a></li>',
            processed_response,
        )
    ...
    def test_charge_page_loads_stripe_js(self):
        ...
        self.assertIn(
            'src="https://checkout.stripe.com/checkout.js"', response.content.decode()
        )
